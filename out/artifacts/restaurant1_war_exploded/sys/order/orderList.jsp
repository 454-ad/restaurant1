...
<body>
	...
	<div id="MainArea">
		...
		<a href="${pageContext.request.contextPath }/order?method=list&currentPage=1">首页</a>
		<a href="${pageContext.request.contextPath }/order?method=list&currentPage=${requestScope.pageBean.currentPage-1}">上一页 </a>
		<a href="${pageContext.request.contextPath }/order?method=list&currentPage=${requestScope.pageBean.currentPage+1}">下一页 </a>
		<a href="${pageContext.request.contextPath }/order?method=list&currentPage=${requestScope.pageBean.totalPage}">末页</a>
		</div>
	</div>
</body>
</html>
