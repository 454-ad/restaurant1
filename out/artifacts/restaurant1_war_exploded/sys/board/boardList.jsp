...
<!-- 过滤条件 -->
<div id="QueryArea">
	<form action="${pageContext.request.contextPath }/table?method=select" method="post">
		...
		<c:forEach items="${requestScope.list }" var="table" varStatus="vs">
			<tr class="TableDetail1">
				...
				<td>
					<c:choose>
						<c:when test="${table.tableStatus==1}">
							<a href="${pageContext.request.contextPath }/table?method=up0&id=${table.id}" class="FunctionButton">退桌</a>
						</c:when>
