	...
	<div id="all">
		<div id="menu">
			...
			<div id="foot">
				...
				<a href="${pageContext.request.contextPath }/index?method=getMenu&currentPage=${requestScope.pageUtils.prevPage}">上一页 </a>
				<a href="${pageContext.request.contextPath }/index?method=getMenu&currentPage=${requestScope.pageUtils.nextPage}">下一页 </a>
				<a href="${pageContext.request.contextPath }/index?method=getMenu&currentPage=${requestScope.pageUtils.lastPage}">末页</a>
