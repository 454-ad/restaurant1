...
<div id="TitleArea">
	...
	<div id="QueryArea">
		<form action="${pageContext.request.contextPath }/food" method="post">
			...
			<input type="text" name="keyword" title="请输入菜品名称" value="${requestScope.keyword}">
		...
		<c:forEach items="${requestScope.list}" var="food" varStatus="vs">
			<tr class="TableDetail1">
				...
				<td>
					...
					<a href="${pageContext.request.contextPath}/food?method=del&id=${food.id}" onClick="return delConfirm();"class="FunctionButton">删除</a>
				</td>
			</tr>
